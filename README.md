...
- **Uniswap V2** forks (via V2 Router)
- **PancakeSwap V3** (via SwapRouter)

Note: Only pools with `v2` or `v3` labels from Dexscreener are supported.
...
| `UNIVERSAL_SWAP_ADDRESS` | Yes | - | Deployed swap contract address |
